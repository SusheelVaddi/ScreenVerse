import { MOCK_ANIME, MOCK_HERO_SLIDES } from "@/data/mockData";
import { PosterCard } from "@/components/ContentCard";

export default function AnimePage() {
  const animeList = [...MOCK_HERO_SLIDES.filter((m) => m.type === "anime"), ...MOCK_ANIME];
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      <div>
        ...
        <p className="text-gray-400 text-sm sm:text-base">
          Dedicated anime exploration: Arcs, Sagas, OVAs, ONAs, Seiyuu voice actors, and Manga source context.
        </p>
      </div>
